  ...
  "koreanFootnotes": [
    {
      ...
      "contentPreview": "매출액 인식 기준: 회사는 고객과의 계약에서 발생하는 수익을 인식...",
      "content": "주석 4: 매출액\n\n회사는 한국채택국제회계기준 제1115호에 따라 매출액을 인식합니다...",
      "targetSection": "주석",
      "targetPage": 45
    }
  ]
...
| 과목 | 주석 | 제5기(2022) | 제4기(2021) |
|------|------|---------------|---------------|
| I. 매출액 | 4,26,33 | 44,621,568 | **42,997,792** |
| II. 매출원가 | 28,33 | 28,993,713 | 24,045,600 |
| III. 매출총이익 | | 15,627,855 | 18,952,192 |

**Document Viewer Highlight:**
- 매출액 **42,997,792** (백만원) 제4기
